...
set DEFAULT_JVM_OPTS="--enable-preview"
...
set CLASSPATH=%APP_HOME%\lib\server-1.0-SNAPSHOT.jar;%APP_HOME%\lib\jbcrypt-0.4.jar


@rem Execute server
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %SERVER_OPTS%  -classpath "%CLASSPATH%" pt.up.fe.cpd.g13.Main %*
